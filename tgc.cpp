...
namespace tgc
{
    namespace details
    {
        ...
        static const char* StateStr[(int)Collector::State::MaxCnt] = { "RootMarking", "LeafMarking", "Sweeping" };

        //////////////////////////////////////////////////////////////////////////

        char* ObjMeta::objPtr() const
        {
            return klass == &ClassMeta::dummy ? dummyObjPtr : (char*)this + sizeof(ObjMeta);
        }
        ...
        {
            return objPtr() + klass->size * arrayLength < r.objPtr() + r.klass->size * r.arrayLength;
        }
        ...
        ObjMeta* ClassMeta::newMeta(size_t objCnt)
        {
            ...
            auto* meta = (ObjMeta*)memHandler(this, MemRequest::Alloc, reinterpret_cast<void*>(objCnt));
